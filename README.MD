...
```
 dotnet add package Dimaser.VictoriaLogs.Dotnet
```
...
```
dotnet add package Dimaser.VictoriaLogs.Dotnet --source [/your-local/package-source]
```
...
In your `Program.cs`
```c#
using Dimaser.VictoriaLogs.Dotnet;
